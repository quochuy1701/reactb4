...
export default class BTDatVe extends Component {
  ...
  renderGhe = () => {
    return this.gheList.map((hangGhe, index) => {
  ...
  render() {
    return (
      <div className='main' style={{ position: "fixed", width: "100%", height: "100%" }}>
        <div style={{ position: "fixed", width: "100%", height: "1000%", backgroundColor: "rgba(0,0,0,0.7)" }}>
          <div className="container-fluid">
            <div className="row">
              <div className="col-8 text-center">
                <div className="text-warning display-4" style={{ fontSize: "20px", paddingLeft: 30 }}>Đặt vé xem phim</div>
                <div className="nt-5" style={{ display: "flex", flexDirection: "row", justifyContent: "center" }}>
                  <div className="manhinh text-light" style={{ fontSize: "15px" }}>Màn Hình</div>
